    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // 2: Record when an item was purchased.
                    // ANSWER: Added a dateAndTime property to the order object. When an order
                    // is created it saves the current date and time into the dateAndTime property
            ...
            // 1: Meyer Truck Equipment's returns are not being processed.
                    // ANSWER: In the ProcessTruckAccessoriesExample() method the generated
                    // return was not being added to the customer object.
            // 2: Ruxer Ford Lincoln, Inc.'s totals are incorrect.
                    ...
                    // I fixed this by implementing overloaded methods for the get methods in both 
                    // repositories, so that you can call it specifying a customer name.
                    // I chose to use an overloaded method over using default parameters in order
                    // to retain the very straight forward return if the full repository is desired.
        ...
        private static void ProcessTruckAccessoriesExample()
        {
            ...
            customer.CreateReturn(rga); // Made sure to return the customer object
